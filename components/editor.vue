...
<template>
    <main>
        <Editor tinymce-script-src="/cdn/tinymce/tinymce.min.js" :init="{
            ...
            toolbar: 'undo redo | formatselect | bold italic underline | forecolor backcolor | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | removeformat | fullscreen | help | image | link | table | code | codesample | preview | print | searchreplace | spellchecker | visualchars | visualblocks | wordcount',
